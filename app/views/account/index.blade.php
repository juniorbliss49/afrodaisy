            ...
            <div class="sidebar-inner slimscrollleft">
               <!-- Search form -->
                ...
                <div class="profile-info">
                    <div class="col-xs-4">
                      <a href="profile.html" class="rounded-image profile-image">{{ HTML::image('images/users/user-100.jpg') }}</a>
                    </div>
                    <div class="col-xs-8">
                ...
                <div id="sidebar-menu">
                    <ul>
                        <li class='has_sub'><a href='javascript:void(0);'><i class='icon-home-3'></i><span>Dashboard</span> <span class="pull-right"><i class="fa fa-angle-down"></i></span></a>
                            <ul><li><a href='index.html' class='active'><span>Dashboard v1</span></a></li><li><a href='index2.html'><span>Dashboard v2</span></a></li></ul>
                        </li>
                        ...
                        <li class='has_sub'><a href='javascript:void(0);'><i class='icon-feather'></i><span>Casting</span> <span class="pull-right">    <i class="fa fa-angle-down"></i></span></a>
                            <ul>
                                ...
                                <li><a href='/account/report'><span>Cast Report</span></a></li>
                        ...
                        <li class='has_sub'><a href='javascript:void(0);'><i class='icon-feather'></i><span>Jobs</span> <span class="pull-right">    <i class="fa fa-angle-down"></i></span></a>
                            <ul>
                                ...
                                <li><a href='/account/joboutstanding'><span>Outstanding Payment</span></a></li>
                                <li><a href='/account/jobrefund'><span>Refund</span></a></li>
                                <li><a href='/account/jobreport'><span>Job Report</span></a></li>
                            </ul>
                        </li>

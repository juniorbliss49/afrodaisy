                ...
                <div id="sidebar-menu">
                    <ul>
                        <li class='has_sub'><a href='javascript:void(0);'><i class='icon-home-3'></i><span>Dashboard</span> <span class="pull-right"><i class="fa fa-angle-down"></i></span></a>
                            <ul><li><a href='index.html'><span>Dashboard v1</span></a></li><li><a href='index2.html'><span>Dashboard v2</span></a></li></ul>
                        </li>
                        <li class='has_sub'><a href='javascript:void(0);'><i class='icon-feather'></i><span>Offline Payment</span> <span class="pull-right">    <i class="fa fa-angle-down"></i></span></a>
                            <ul>
                                <li><a href='/account/offphoto'><span>Photosession</span></a></li>
                                <li><a href='/account/offcourses'><span>Courses</span></a></li>
                                <li><a href='/account/offservice'><span>Services</span></a></li>
                                <li><a href='/account/offcast'><span>Cast</span></a></li>
                                <li><a href='/account/offjobs'><span>Jobs</span></a></li>
                                <li><a href='/account/offsub'><span>Subscription</span></a></li>
                            </ul>
                        </li>
                        <li class='has_sub'><a href='javascript:void(0);'><i class='icon-feather'></i><span>Casting</span> <span class="pull-right">    <i class="fa fa-angle-down"></i></span></a>
                            <ul>
                                <li><a href='/account/unpaid'><span>Unpaid Casting</span></a></li>
                                <li><a href='/account/paid'><span>Paid Casting</span></a></li>
                                <li><a href='/account/reciept'><span>View Receipt</span></a></li>
                                <li><a href='/account/payment'><span>Payment</span></a></li>
                                <li><a href='/account/outstanding'><span>Outstanding Payment</span></a></li>
                                <li><a href='/account/refund'><span>Refund</span></a></li>
                                <li><a href='/account/report' class='active'><span>Cast Report</span></a></li>
                                <li><a href='/account/application'><span>Cast Application</span></a></li>
                            </ul>
                        </li>
                        <li class='has_sub'><a href='javascript:void(0);'><i class='icon-feather'></i><span>Jobs</span> <span class="pull-right">    <i class="fa fa-angle-down"></i></span></a>
                            <ul>
                                <li><a href='/account/jobreceipt'><span>View Receipt</span></a></li>
                                <li><a href='/account/jobpayment'><span>Payment</span></a></li>
                            </ul>
                        </li>
                        <li class='has_sub'><a href='javascript:void(0);'><i class='icon-feather'></i><span>Market Place</span> <span class="pull-right">    <i class="fa fa-angle-down"></i></span></a>
                            <ul>
                                <li><a href='/account/courses'><span>Courses</span></a></li>
                                <li><a href='/account/services'><span>Service</span></a></li>
                                <li><a href='/account/photosession'><span>Photosession</span></a></li>
                                <li><a href='/account/booked'><span>Booked</span></a></li>
                            </ul>
                        </li>
                        <li class='has_sub'><a href='javascript:void(0);'><i class='icon-feather'></i><span>Subscription</span> <span class="pull-right">    <i class="fa fa-angle-down"></i></span></a>
                            <ul>
                                <li><a href='/account/afrounlimited'><span>Afro Unlimited</span></a></li>
                                <li><a href='/account/afroplus'><span>Afro Plus</span></a></li>
                                <li><a href='/account/free'><span>Free</span></a></li>
                            </ul>
                        </li>
                        <li class='has_sub'><a href='javascript:void(0);'><i class='icon-feather'></i><span>Advert</span> <span class="pull-right">    <i class="fa fa-angle-down"></i></span></a>
                            <ul>
                                <li><a href='/account/advert'><span>Advert</span></a></li>
                            </ul>
                        </li>
                        <li class='has_sub'><a href='javascript:void(0);'><i class='icon-feather'></i><span>Income & Expenses</span> <span class="pull-right">    <i class="fa fa-angle-down"></i></span></a>
                            <ul>
                                <li><a href='/account/income'><span>Income</span></a></li>
                                <li><a href='/account/expenses'><span>Expenses</span></a></li>
                                <li><a href='/account/summary'><span>Summary</span></a></li>
                            </ul>
                        </li>
        ...
        <div class="content-page">
            ...
            <div class="content">
                ...
                <div class="page-heading">
                    <h1><i class='fa fa-table'></i> Cast Report</h1>
                    </div>
                        ...
                        <div class="widget">
                            ...
                            <br>                    
                                ...
                                <div class="col-lg-3">
                                        {{ Form::label('From') }}
                                        <br>
                                        {{ Form::selectRange('fromDay', 0, 31); }}
                                        {{ Form::selectMonth('fromMonth'); }}
                                        {{ Form::selectRange('fromYear', 2016, 2020); }}
                                    </div>
                                    <div class="col-lg-3">
                                        {{ Form::label('To') }}
                                        <br>
                                        {{ Form::selectRange('toDay', 0, 31); }}
                                        {{ Form::selectMonth('toMonth'); }}
                                        {{ Form::selectRange('toYear', 2016, 2020); }}
                                    </div>
                                    <div class="col-lg-2">
                                        {{ Form::label('select') }}
                                        <br>
                                        {{ Form::select('paystatus', array('' => '--Please select--', 'paid' => 'Paid', 'unpaid' => 'Unpaid')); }}
                                    </div>
                                    <div class="col-lg-2">
                                    ...
                                    <div class="col-lg-2">
                                        <br>
                                        <button class="btn btn-success btnfilter">
                                            Search
                                        </button>
                                    </div>
                                    <br>

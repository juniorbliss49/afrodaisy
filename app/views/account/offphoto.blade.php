                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li class='has_sub'><a href='javascript:void(0);'><i class='icon-feather'></i><span>Offline Payment</span> <span class="pull-right">    <i class="fa fa-angle-down"></i></span></a>
                            <ul>
                                <li><a href='/account/offphoto' class='active'><span>Photosession</span></a></li>
        ...
        <div class="content-page">
            ...
            <div class="content">
                ...
                <div class="page-heading">
                    <h1><i class='fa fa-table'></i> Photosession</h1>
                    </div>
  ...
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="exampleModalLabel">Photosession</h4>
      </div>

                    ...
                    <ul>
                        ...
                        <li class='has_sub'><a href='javascript:void(0);'><i class='icon-feather'></i><span>Casting</span> <span class="pull-right">    <i class="fa fa-angle-down"></i></span></a>
                            <ul>
                                ...
                                <li><a href='/account/payment' class='active'><span>Payment</span></a></li>
        ...
        <div class="content-page">
            ...
            <div class="content">
				...
				<div class="page-heading">
            		<h1><i class='fa fa-table'></i> Payment Slip</h1>
            		</div>
				...
				<div class="row">
					...
					<div class="col-md-12">				
						<div class="widget">
							...
							<div class="widget-content">	
							{{ Form::open(array('url' => 'account/createpayment')) }}
								<div class="table-responsive">
                                    <input type="hidden" name="cast_id" value="{{$getcast->id}}">
                                    
                                    <br>
                                        <div class="col-lg-12 text-center">
                                            <a class="btn btn-success" target="#" href="/account/printpaymentslip/{{$getcast->id}}/{{$ackid}}">
                                                Print Payment Slip
                                            </a>
                                        </div>

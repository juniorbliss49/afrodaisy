                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li class='has_sub'><a href='javascript:void(0);'><i class='icon-feather'></i><span>Jobs</span> <span class="pull-right">    <i class="fa fa-angle-down"></i></span></a>
                            <ul>
                                <li><a href='/account/jobreciept'><span>View Receipt</span></a></li>
                                <li><a href='/account/jobpayment' class='active'><span>Payment</span></a></li>
                            </ul>
                        </li>
								...
								<div class="table-responsive">
                                    ...
                                    <br>
                                        <div class="col-lg-12 text-center">
                                            <a class="btn btn-success" target="#" href="/account/printjobpaymentslip/{{$getcast->id}}">
                                                Print Payment Slip
                                            </a>
                                        </div>

                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li class='has_sub'><a href='javascript:void(0);'><i class='icon-feather'></i><span>Advert</span> <span class="pull-right">    <i class="fa fa-angle-down"></i></span></a>
                            <ul>
                                <li><a href='/account/advert' class='active'><span>Advert</span></a></li>
                            </ul>
                        </li>
        ...
        <div class="content-page">
            ...
            <div class="content">
                ...
                <div class="page-heading">
                    <h1><i class='fa fa-table'></i> Advert</h1>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget">
                            ...
                            <div class="widget-content">
                            {{ Form::open(array('url' => 'account/createadvert')) }}    
                                    <div class="col-lg-2">
                                        <label>User</label>
                                        <br>
                                    ...
                                    <br>
                                        <button class="btn btn-success getinc">Send</button>
                                    </div>
                                {{ Form::close() }}
                                    <br>
                                    <br>

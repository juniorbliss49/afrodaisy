                    ...
                    <ul>
                        ...
                        <li class='has_sub'><a href='javascript:void(0);'><i class='icon-feather'></i><span>Casting</span> <span class="pull-right">    <i class="fa fa-angle-down"></i></span></a>
                            <ul>
                                ...
                                <li><a href='/account/application' class='active'><span>Cast Application</span></a></li>
                            </ul>
                        </li>
        ...
        <div class="content-page">
            ...
            <div class="content">
                ...
                <div class="page-heading">
                    <h1><i class='fa fa-table'></i> Cast Application</h1>
                    </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="exampleModalLabel">Pay slip</h4>
      </div>

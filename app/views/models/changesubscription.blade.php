            ...
            <div class="row">
                <div class="col-lg-12 payHT col1">                    
                   ...
                   <h4 class="line">Sign up for free and have an experience on what it takes to be a model. </h4><span class="glyphicon glyphicon-info-sign" data-toggle="tooltip" data-placement="bottom" title=" It really doesn’t take much to be required in the modeling industry. Yes!  The modeling industries are looking for you and what you can offer. Apply for jobs and receive your reward for your services"></span>
                    <a href="/models/changeplan/1" class="btn btn-lg btn-block" id="dash"><span class="glyphicon glyphicon-download"></span> GET IT</a>  
                </div>
            ...
            <div class="row"> 
                <div class="col-lg-12 payHT col2">
                   ...
                   <hr>
                    ...
                    <button class="btn btn-lg btn-block regplan" data-toggle='modal' data-target='#exampleModal' style="background: #54d7e3; color: #fff;" id="2"><span class="glyphicon glyphicon-download"></span> GET IT</button>    
                </div>
                <div class="col-lg-12" style="border: 1px solid #000; font-weight: bold;">
                <br>
            ...
            <div class="row">
                <div class="col-lg-12 payHT col3">
                   ...
                   <hr>
                    ...
                    <button class="btn btn-lg btn-block regplan" data-toggle='modal' data-target='#exampleModal' style="background: #54d7e3; color: #fff;" id="3"><span class="glyphicon glyphicon-download"></span> GET IT</button>    
                </div>
                <div class="col-lg-12" style="border: 1px solid #000; font-weight: bold;">
                    <br>

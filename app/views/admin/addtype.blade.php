                    ...
                    <ul>
                        ...
                        <li class='has_sub'><a href='javascript:void(0);'><i class='fa  fa-plus'></i><span>Add fields</span> <span class="pull-right"><i class="fa fa-angle-down"></i></span></a>
                            <ul>
                                ...
                                <li><a href='/admin/addtype' class='active'><span>Add Model Type </span></a></li>
						...
						<div class="widget">
							...
							<div class="widget-content">	
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                    {{ Form::open(array('url' => 'admin/sendtype')) }}
                                        {{ Form::text('Name', $value = null, $attributes = array('id' => 'exampleInputEmail1', 'placeholder' => 'Type Name', 'size' => '30', 'class' => 'form-control')) }}

        ...
        <div class="content-page">
            ...
            <div class="content">
                ...
                <div class="page-heading">
                    <h1><i class='fa fa-table'></i> Cast Tracking</h1>
                    </div>
                            ...
                            <br>                    
                                <div class="table-responsive">
                                    <table id="datatables-1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <?php
                                        $id += 1;
                                            $date1 = strtotime("$user->Yearcast-$user->Monthcast-$user->Daycast");    
                                            $datecast = date('l, j F Y', $date1);
                                        ?>  
                                                <tr>
                                                    <td>{{$id}}</td>
                                                    <td><strong>{{$user->castcode}}</strong></td>
                                                    <td>{{$datecast}}</td>
                                                    ...
                                                    <td></td>
                                                    @endif
                                                    <td><a href="/admin/castevent/{{$user->id}}" class='btn btn-sm btn-success'>View</a></td>
                                                </tr>

                    ...
                    <ul>
                        ...
                        <li class='has_sub'><a href='javascript:void(0);'><i class='fa fa-table'></i><span>Cast</span> <span class="pull-right"><i class="fa fa-angle-down"></i></span></a>
                            <ul>>
                                ...
                                <li><a href='/admin/pendingcast' class="active"><span>Pending cast Request</span></a></li>
        ...
        <div class="content-page">
            ...
            <div class="content">
				...
				<div class="page-heading">
            		<h1><i class='fa fa-table'></i> {{$getcast->castTitle}}</h1>
            		</div>
                            ...
                            <div class='row' style="padding-left: 10px">
                                <div class='col-lg-12'>
                                    ...
                                    <div class="row hideit">
                                        <div class="col-lg-12">
                                            <button class="btn btn-success acceptcast" id="{{$castId}}">
                                                Accept
                                            </button>
                                            <button class="btn btn-danger declinecast" id="{{$castId}}">
                                                Decline
                                            </button>
                                        </div>
                                    </div>

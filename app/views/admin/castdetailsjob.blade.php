                ...
                <div id="sidebar-menu">
                    <ul>
                        <li class='has_sub'><a href='javascript:void(0);'><i class='icon-home-3'></i><span>Dashboard</span> <span class="pull-right"><i class="fa fa-angle-down"></i></span></a>
                            <ul><li><a href='/' class='active'><span>Dashboard v1</span></a></li><li><a href='index2.html'><span>Dashboard v2</span></a></li></ul>
                        </li>
                        ...
                        <li class='has_sub'><a href='javascript:void(0);'><i class='fa fa-table'></i><span>Cast</span> <span class="pull-right"><i class="fa fa-angle-down"></i></span></a>
                            <ul>>
                                <li><a href='/admin/casttrack'><span>Cast Tracking</span></a></li>
                        ...
                        <li class='has_sub'><a href='javascript:void(0);'><i class='fa fa-table'></i><span>Jobs</span> <span class="pull-right"><i class="fa fa-angle-down"></i></span></a>
                            <ul>>
                                ...
                                <li><a href='/admin/pendingjob' class="active"><span>Pending Job Request</span></a></li>
        ...
        <div class="content-page">
            ...
            <div class="content">
				...
				<div class="page-heading">
            		<h1><i class='fa fa-table'></i> {{$getcast->title}}</h1>
            		</div>
						...
						<div class="widget">
							...
							<div class="widget-content">	
                                 ...
                                 <div class='row' style="padding-left: 10px">
                                    <div class="col-lg-12">
                                        <h4><strong>User:</strong> <a href="#name" id="{{$getuser->user_id}}" class="viewother" data-toggle="modal" data-target="#exampleModal">{{$getuser->agentName}}</a></h4>
                                        <h4>Number of Previous Jobs {{$getprev}}</h4>
                                    </div>
                                 </div>
                                 <div class='row' style="padding-left: 10px">
                        <div class='col-lg-3'>
                    ...
                    <br>
                            <div class='row' style="padding-left: 10px">
                                <div class='col-lg-12'>
                                    <div class='row'>
                                        <div class='col-lg-6'>
                                        <p><strong>Job Title: </strong>{{$getcast->title}}</p>
                                        <p><strong>Job Profession: </strong>{{$getcast->user_spec}}</p>
                                        <p><strong>Job Country: </strong>{{$getcast->country}}</p>
                                        <p><strong>Job State: </strong>{{$getcast->location}}</p>
                                        <p><strong>Job Area: </strong>{{$getcast->area}}</p>
                                        </div>
                                        <div class='col-lg-6'>
                                        <p><strong>Job Task:</strong>{{$getcast->job_task}}</p>
                                        <p><strong>Amount: </strong>{{$getcast->amount}}</p>
                                        <p><strong>Events Start:</strong>{{$getcast->jobYear}}-{{$getcast->jobMonth}}-{{$getcast->jobDay}}</p>
                                    ...
                                    <div class='row'>
                                        <div class='col-lg-12'>
                                        <p><strong>Job Description: </strong>{{$getcast->job_description}}</p>
                                        </div>
                                    </div>
                                    <div class="row hideit">
                                        <div class="col-lg-12">
                                            <button class="btn btn-success acceptjob" id="{{$castId}}">
                                                Accept
                                            </button>
                                            <button class="btn btn-danger declinejob" id="{{$castId}}">
                                                Decline
                                            </button>
                                        </div>
                                    </div>

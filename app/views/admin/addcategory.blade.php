                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li class='has_sub'><a href='javascript:void(0);'><i class='fa  fa-plus'></i><span>Add fields</span> <span class="pull-right"><i class="fa fa-angle-down"></i></span></a>
                            <ul>
                                <li><a href='/admin/addcategory' class='active'><span>Add Model Category</span></a></li>
        ...
        <div class="content-page">
            ...
            <div class="content">
				...
				<div class="page-heading">
            		<h1><i class='fa fa-table'></i> Models Category</h1>
            		</div>
						...
						<div class="widget">
							...
							<div class="widget-content">	
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                    {{ Form::open(array('url' => 'admin/addcat')) }}
                                        {{ Form::text('Name', $value = null, $attributes = array('id' => 'exampleInputEmail1', 'placeholder' => 'Category Name', 'size' => '30', 'class' => 'form-control')) }}
                                        {{ $errors->first('Name', '<p style="color:red;"><i>:message</i></p>') }}
                                    </div>
                                    <div class="col-lg-1">
                                        {{ Form::submit('ADD',  $attributes = array('class' => 'btn btn-primary btn-sm')) }}
                                    {{ Form::close() }}
                                    </div>
                                </div>
                                <br>

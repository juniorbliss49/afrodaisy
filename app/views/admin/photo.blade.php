                    ...
                    <ul>
                        ...
                        <li class='has_sub'><a href='javascript:void(0);'><i class='icon-feather'></i><span>Users</span> <span class="pull-right">    <i class="fa fa-angle-down"></i></span></a>
                            <ul>
                                ...
                                <li><a href='/admin/photo' class='active'><span>Photographer</span></a></li>
        ...
        <div class="content-page">
            ...
            <div class="content">
                ...
                <div class="page-heading">
                    <h1><i class='fa fa-table'></i> Photographers</h1>
                    </div>
                                        ...
                                        ?>
                                            @if(!empty($user->verify))
                                                ...
                                                {{HTML::image('img/photo.jpg', 'profile picture', array('width' => '50px', 'height' => '50px'));}}
                                                    ...
                                                    <td><a id="{{$user->id}}" href="/admin/othersview/{{$user->id}}" class='btn btn-sm btn-success viewother'>View</a></td>
                                                </tr>
                                            @else
                                                <tr>
                                                    <td>{{$id}}</td>

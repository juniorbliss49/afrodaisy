                    ...
                    <ul>
                        ...
                        <li class='has_sub'><a href='javascript:void(0);'><i class='icon-feather'></i><span>Users</span> <span class="pull-right">    <i class="fa fa-angle-down"></i></span></a>
                            <ul>
                                ...
                                <li><a href='notifications.html'><span>Others</span></a></li>
                            </ul>
                        </li>
                        ...
                        <li class='has_sub'><a href='javascript:void(0);'><i class='fa fa-table'></i><span>Cast</span> <span class="pull-right"><i class="fa fa-angle-down"></i></span></a>
                            <ul>
                                <li><a href='/admin/casttracking' class="active"><span>Cast Tracking</span></a></li>
                        ...
                        <li class='has_sub'><a href='javascript:void(0);'><i class='fa fa-table'></i><span>Jobs</span> <span class="pull-right"><i class="fa fa-angle-down"></i></span></a>
                            <ul>>
                                <li><a href='/admin/jobtracking' class="active"><span>Job Tracking</span></a></li>
        ...
        <div class="content-page">
            ...
            <div class="content">
                ...
                <div class="page-heading">
                    <h1><i class='fa fa-table'></i> Job Tracking</h1>
                    </div>
                            ...
                            <br>                    
                                <div class="table-responsive">
                                    <table id="datatables-1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        $id = 0;
                                        ?>
                                        @foreach($gettracking as $user)
                                        <?php
                                        $id += 1;
                                            $date1 = strtotime("$user->jobYear-$user->jobMonth-$user->jobDay");    
                                            $datecast = date('l, j F Y', $date1);
                                        ?>  
                                                <tr>
                                                    <td>{{$id}}</td>
                                                    <td><strong>{{$user->jobcode}}</strong></td>
                                                    <td>{{$datecast}}</td>
                                                    @if(!empty($user->status == 'checkout'))
                                                    <td><button class="btn btn-sm btn-success">checked out</button></td>            
                                                    @else
                                                    <td></td>
                                                    @endif
                                                    <td><a href="/admin/jobevent/{{$user->id}}" class='btn btn-sm btn-success'>View</a></td>
                                                </tr>

                ...
                <div id="sidebar-menu">
                    <ul>
                        <li class='has_sub'><a href='javascript:void(0);'><i class='icon-home-3'></i><span>Dashboard</span> <span class="pull-right"><i class="fa fa-angle-down"></i></span></a>
                            <ul><li><a href='index.html' class='active'><span>Dashboard v1</span></a></li><li><a href='/'><span>Dashboard v2</span></a></li></ul>
                        </li>
        ...
        <div class="content-page">
            ...
            <div class="content">
                ...
                <div class="page-heading">
                    <h1><i class='fa fa-table'></i> Declined Applicants</h1>
                    </div>
                                ...
                                <div class="table-responsive">
                                    <table id="datatables-1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        ?>
                                                <tr>
                                                    <td>{{$id}}</td>
                                                    <td>{{$cast->castTitle}}</td>
                                                    <td><span class="label label-danger">Pending</span></td>
                                                    <td><a href="/admin/castdetails/{{$cast->id}}" class="btn btn-sm btn-success">View Cast</a></td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                        </table>

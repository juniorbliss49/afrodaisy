                    ...
                    <ul>
                        ...
                        <li class='has_sub'><a href='javascript:void(0);'><i class='icon-feather'></i><span>Users</span> <span class="pull-right">    <i class="fa fa-angle-down"></i></span></a>
                            <ul>
                                ...
                                <li><a href='/admin/tattoo' class='active'><span>Tattoo Artist</span></a></li>
        ...
        <div class="content-page">
            ...
            <div class="content">
                ...
                <div class="page-heading">
                    <h1><i class='fa fa-table'></i> Tattoo Artist</h1>
                    </div>
                                        ...
                                        ?>
                                            @if(!empty($user->verify))
                                                ...
                                                {{HTML::image('img/photo.jpg', 'profile picture', array('width' => '50px', 'height' => '50px'));}}
                                                    @endif
                                                    <strong>{{$user->agentName}}</strong></td>
                                                    <td>{{$user->location}}</td>
                                                    <td>{{$social}}</td>
                                                    <td>{{$mobile}}</td>
                                                    <td>{{$email}}</td>
                                                    <td><span class="label label-success">Active</span></td>
                                                    <td><a id="{{$user->id}}" class='btn btn-sm btn-success' href="/admin/othersview/{{$user->id}}">View</a></td>
                                                </tr>
                                            @else
                                                <tr>
                                                    <td>{{$id}}</td>
                                                ...
                                                {{HTML::image('img/photo.jpg', 'profile picture', array('width' => '50px', 'height' => '50px'));}}
                                                    ...
                                                    <td><button id="{{$user->id}}" class='btn btn-sm btn-success viewother' data-toggle="modal" data-target="#exampleModal">View</button></td>
                                                </tr>
                                            @endif

                        ...
                        <div class="widget">
                            ...
                            <br>                 
                                ...
                                <div class="col-lg-12">
                                    <div class="row">
                                    <div class="col-lg-6">
                                        <h2><b>FirstName:</b> {{$getuser->firstName}}</h2>
                                        <h2><b>Display Name:</b> {{$getuser->displayName}}</h2>
                                        <h2><b>Birthday:</b> {{$getuser->MonthOfBirth}} / {{$getuser->DayofBirth}} / {{$getuser->YearofBirth}}</h2>
                                        <h2><b>Phone:</b> {{$getuser->phone}}</h2>
                                        <h2><b>Country:</b> {{$getuser->country}}</h2>
                                        <h2><b>Alt Phone:</b> {{$getuser->altPhone}}</h2>
                                    </div>
                                    <div class="col-lg-6">
                                        <h2><b>LastName:</b> {{$getuser->lastName}}</h2>
                                        <h2><b>Gender:</b> {{$getuser->gender}}</h2>
                                        <h2><b>Age:</b> {{$getuser->Age}}</h2>
                                        <h2><b>Height:</b> {{$getuser->Height}}</h2>
                                ...
                                <div class="col-lg-12">
                                        <h2><b>Plan</b></h2>
                                        @if($getplan->plan_id == '1')
                                        <h3>Free user</h3>
                                        @elseif($getplan->plan_id == '2')
                                        <h3>Afro plus</h3>
                                        @elseif($getplan->plan_id == '3')
                                        <h3>Afro Unlimited</h3>
                                        @endif
                                    <hr>
                                    <br>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <h2><b>Chest/Burst:</b> {{$getmodel->chestbust}}</h2>
                                            <h2><b>Waist:</b> {{$getmodel->waist}}</h2>
                                            <h2><b>Hips:</b>: {{$getmodel->hips}}</h2>
                                            <h2><b>Dress:</b> {{$getmodel->dress}}</h2>
                                            <h2><b>Jacket:</b> {{$getmodel->jacket}}</h2>
                                            <h2><b>Trousers:</b> {{$getmodel->trousers}}</h2>
                                            <h2><b>Collar:</b> {{$getmodel->collar}}</h2>
                                            <h2><b>Qualification:</b> {{$getmodel->qualification}}</h2>
                                        </div>
                                        <div class="col-lg-6">
                                            <h2><b>Shoes:</b> {{$getmodel->shoes}}</h2>
                                            <h2><b>Eyes:</b> {{$getmodel->eyes}}</h2>
                                            <h2><b>Hair Color:</b> {{$getmodel->hair_color}}</h2>
                                            <h2><b>Ethnicity:</b> {{$getmodel->ethnicity}}</h2>
                                            <h2><b>Language:</b> {{$getmodel->languages}}</h2>
                                            <h2><b>Complexion:</b> {{$getmodel->complexion}}</h2>
                                            <h2><b>Butt:</b> {{$getmodel->butt}}</h2>
                                            <h2><b>Hair Type:</b> {{$getmodel->Hair_type}}</h2>
                                        </div>
                                    </div>
                                </div>
                                @else
                                ...
                                <div class="col-lg-12 col-sm-12">
                                    <h2 style="color: #222; font-weight: bold;">CATEGORIES</h2>
                                    <div class="col-lg-12 col-sm-12">
                                        <div class="row">
                                    @foreach($dis as $disk)

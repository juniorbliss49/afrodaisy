                    ...
                    <ul>
                        ...
                        <li class='has_sub'><a href='javascript:void(0);'><i class='icon-feather'></i><span>Users</span> <span class="pull-right">    <i class="fa fa-angle-down"></i></span></a>
                            <ul>
                                ...
                                <li><a href='/admin/promodel' class='active'><span>Professional Models</span></a></li>
        ...
        <div class="content-page">
            ...
            <div class="content">
                ...
                <div class="page-heading">
                    <h1><i class='fa fa-table'></i> Professional Models</h1>
                    </div>
                                    ...
                                    <table id="datatables-1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        ?>
                                            @if(!empty($user->verify))
                                                ...
                                                {{HTML::image($user->imagename ,'profile', array('width' => '50px', 'height' => '50px'));}}
                                                    @else
                                                {{HTML::image('img/photo.jpg', 'profile picture', array('width' => '50px', 'height' => '50px'));}}
                                                    @endif
                                                    <strong>{{$user->displayName}}</strong></td>
                                                    <td>{{$user->country}}, {{$user->location}}</td>
                                                    <td>{{$social}}</td>
                                                    <td>{{$mobile}}</td>
                                                    <td>{{$email}}</td>
                                                    <td><span class="label label-success">Active</span></td>
                                                    <td><a id="{{$user->id}}" class='btn btn-sm btn-success' href="/admin/modelsview/{{$user->id}}">View</a></td>
                                                </tr>
                                            @else
                                                <tr>
                                                    <td>{{$id}}</td>
                                                ...
                                                {{HTML::image('img/photo.jpg', 'profile picture', array('width' => '50px', 'height' => '50px'));}}
                                                    ...
                                                    <td><button id="{{$user->id}}" class='btn btn-sm btn-success viewModel' data-toggle="modal" data-target="#exampleModal">View</button></td>
                                                </tr>
                                            @endif

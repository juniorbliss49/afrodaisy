	...
	<div class="container">
		<div class="full-content-center">
			...
			<div class="login-wrap animated flipInX">
				...
				{{ Form::open(array('url' => 'user/Logincpanel')) }}
						<div class="form-group login-input">
						<i class="fa fa-user overlay"></i>
				 	{{ Form::email('email', $value = null, $attributes = array('class' => 'form-control text-input', 'placeholder' => 'Username')) }}
						</div>
						<div class="form-group login-input">
						<i class="fa fa-key overlay"></i>
				  {{ Form::password('password', $attributes = array('id' => 'exampleInputPassword1', 'placeholder' => '"********"', 'class' => 'form-control text-input')) }}
						</div>

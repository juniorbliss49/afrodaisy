...
<div class="col-lg-2 col-sm-2">
				...
				<div class="row">
					...
					<ul class="list-profile">
						<a href="/others/joblisting"><li>Job Contract <span class="text-right glyphicon glyphicon-play"></span></li></a>
			...
			<div class="col-lg-10 col-sm-10 dash-bd">
					<div class="row">
						<br>
						<br>
						<h4><b>Course sent successfully, Kindly wait for www.afrodaisymodels.com team to approve your Course</b></h4>

...
<div class="col-lg-2 col-sm-2">
			...
			<div class="col-lg-10 col-sm-10 dash-bd">
					...
					<div class="row">
						<div class="col-lg-12 col-sm-12">
							<ul class="nav nav-tabs" role="tablist">
							    <li role="presentation" class="active"><a href="#mymodels" aria-controls="mymodels" role="tab" data-toggle="tab">Add services</a></li>
							    <li role="presentation"><a href="#service" aria-controls="service" role="tab" data-toggle="tab">Manage Services</a></li>
						  	</ul>
						</div>
				    </div>
					...
					{{ Form::open(array('url' => 'others/createservice', 'files'=>true)) }}
	<div class="well">
	<div class="row">
	...
	<div class="well">
		...
		<div class="col-lg-6 col-sm-8">
			{{ Form::label('Service Description(Email addresses are not permitted in the description)') }}
		 	{{ Form::textarea('description', $value = '', array('class' => 'form-control')) }}
						    	...
						    	<br>
						    		...
						    		<div class="row" style="border: 1px #000 solid">
						    			...
						    			<div class="col-lg-4 col-sm-4 col-xs-12">
						    				<br>
						    				<h5><strong>Title :</strong> {{$data->name}}</h5>
						    			...
						    			<div class="col-lg-4 col-sm-4 col-xs-12 text-center">
						    				...
						    				$value = 'service'
						    				?>
						    				<a href="/others/servicemgt/{{$value}}/{{$data->id}}" class="btn btn-sm btn-primary"><i class="fa fa-users"></i> view applied users</a>
						    				<br>
						    				<br>
						    				<button class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i> Discard Service</button>
						    			</div>

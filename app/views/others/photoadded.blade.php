...
<div class="col-lg-2 col-sm-2">
				...
				<div class="row">
					...
					<ul class="list-profile">
						...
						<a href="/others/newcasting"><li>Create new casting <span class="text-right glyphicon glyphicon-play"></span></li></a>
					</ul>
				</div>
				<div class="row">
					<br>
			...
			<div class="col-lg-10 col-sm-10 dash-bd">
					<div class="row">
						<br>
						<br>
						<h4><b>Photosession sent successfully, Kindly wait for www.afrodaisymodels.com team to approve your Photosession</b></h4>

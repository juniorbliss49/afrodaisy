...
<div class="col-lg-2 col-sm-2">
			...
			<div class="col-lg-10 col-sm-10 dash-bd">
					<div class="row">
						<br>
						<br>
						<h4><b>Contract Sent successfully, kindly wait for www.afrodaisymodels.com team to approve your contract</b></h4>
						<h4><i style="color: red"><b> Note: You can manage your Contract after approval and confirm your models and check out accordingly </b></i></h4>
						<h4><i><b>You will be sent a text when approved</h4>
					</div>
			</div>

...
<div class="col-lg-2 col-sm-2">
  ...
  <div class="row">
  	<div class="col-lg-12 col-sm-12">
		    ...
		    <li role="presentation" class="active"><a href="#mymodels" aria-controls="mymodels" role="tab" data-toggle="tab">My Models</a></li>
		    <li role="presentation"><a href="#contacts" aria-controls="contacts" role="tab" data-toggle="tab">New Contacts</a></li>
		  </ul>
  	</div>
  </div>
  ...
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="exampleModalLabel">Decline models</h4>
      </div>

...
<div class="col-lg-2 col-sm-2">
			...
			<div class="col-lg-10 col-sm-10 dash-bd">
					...
					<div class="row">
						<div class="col-lg-12 col-sm-12">
							<ul class="nav nav-tabs" role="tablist">
							    <li role="presentation" class="active"><a href="#mymodels" aria-controls="mymodels" role="tab" data-toggle="tab">Add Courses</a></li>
							    <li role="presentation"><a href="#service" aria-controls="service" role="tab" data-toggle="tab">Manage Courses</a></li>
						  	</ul>
						</div>
				    </div>
					...
					{{ Form::open(array('url' => 'others/createcourses', 'files'=>true)) }}
	<div class="well">
	<div class="row">
						    	...
						    	<br>
						    		...
						    		<div class="row" style="border: 1px #000 solid">
						    			...
						    			<div class="col-lg-4 col-sm-4 col-xs-12 text-center">
						    				...
						    				<br>
						    				<br>
						    				<button class="btn btn-danger"><i class="fa fa-trash-o"></i> Discard Service</button>
						    			</div>

...
@section('content')
    ...
    {{ Form::open(array('url' => 'pay/Photosession')) }}
                        <a class="btn btn-primary Offlinebtn" target="_" href="/others/offlinepayoutphotosession/{{$getphotocourse->id}}" style="display: none;">Book offline</a>

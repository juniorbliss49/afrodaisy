               ...
               <!-- Search form -->
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li class='has_sub'><a href='javascript:void(0);'><i class='fa fa-map-marker'></i><span>Accounting</span> <span class="pull-right"><i class="fa fa-angle-down"></i></span></a>
                            <ul>
                                <li><a href='google-maps.html'><span>Payment System</span></a></li>
                                <li><a href='vector-maps.html'><span>Income</span></a></li>
                            </ul>
                        </li>
                        <li class='has_sub'><a href='javascript:void(0);'><i class='fa  fa-plus'></i><span>Market Place</span> <span class="pull-right"><i class="fa fa-angle-down"></i></span></a>
                            <ul>
                                <li><a href='/admin/services' class="active"><span>Services</span></a></li>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="exampleModalLabel">Service Profile</h4>
      </div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-success sendmsg">Send</button>
      </div>
    </div>
  </div>
</div>

...
@section('content')
    ...
    {{ Form::open(array('url' => 'pay/Course')) }}
                        <a class="btn btn-primary Offlinebtn" target="_" href="/others/offlinepayoutcourses/{{$getphotocourse->id}}" style="display: none;">Book offline</a>
                        <input type="hidden" name="amount" value="{{$getphotocourse->price}}">
